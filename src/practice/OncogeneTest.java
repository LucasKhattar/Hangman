...
public class OncogeneTest {
	...
	ArrayList<String> healthySequences = new ArrayList<String>(
			Arrays.asList(new String[] { "TGCATCC", "AAATTTGGGCCC", "ATGCGCTA", "GGGTACGGAG", "TTAATTGGG" }));

	ArrayList<String> cancerSequences = new ArrayList<String>(Arrays.asList(new String[] { "ATTTGCAGG", "TGCAAATTA",
			"AAAGGGCCCTTT", "TGCGATACGTAGGACCA", "ACTCATTAGTGC", "AAACGCTAGACACACAAG", "GGGGGGGGGGGG" }));

	ArrayList<String> sequencesWithInvalidElement = new ArrayList<String>(
			Arrays.asList(new String[] { "ATTTGGG", "TGCGATTTA", "TGCGGHACCA", "ACTCATTAGTGC" }));
